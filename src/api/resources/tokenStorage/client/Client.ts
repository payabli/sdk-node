...
export class TokenStorageClient {
     ...
     *     })
     */
    public addMethod(request: Payabli.AddMethodRequest, requestOptions?: TokenStorageClient.RequestOptions): core.HttpResponsePromise<Payabli.AddMethodResponse> {
     ...
     *     })
     */
    public getMethod(methodId: string, request: Payabli.GetMethodRequest = {}, requestOptions?: TokenStorageClient.RequestOptions): core.HttpResponsePromise<Payabli.GetMethodResponse> {
     ...
     *     })
     */
    public updateMethod(methodId: string, request: Payabli.UpdateMethodRequest, requestOptions?: TokenStorageClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponsePaymethodDelete> {
    ...
    private async __updateMethod(methodId: string, request: Payabli.UpdateMethodRequest, requestOptions?: TokenStorageClient.RequestOptions): Promise<core.WithRawResponse<Payabli.PayabliApiResponsePaymethodDelete>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Payabli.PayabliApiResponsePaymethodDelete, rawResponse: _response.rawResponse };
        }
     ...
     */
    public removeMethod(methodId: string, requestOptions?: TokenStorageClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponsePaymethodDelete> {
