...
export class BoardingClient {
     ...
     *     })
     */
    public addApplication(request: Payabli.AddApplicationRequest, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse00Responsedatanonobject> {
     ...
     */
    public updateApplication(appId: number, request: Payabli.ApplicationData, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse00Responsedatanonobject> {
     ...
     */
    public deleteApplication(appId: number, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse00Responsedatanonobject> {
     ...
     */
    public getApplication(appId: number, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.ApplicationDetailsRecord> {
     ...
     *     })
     */
    public getApplicationByAuth(xId: string, request: Payabli.RequestAppByAuth = {}, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.ApplicationQueryRecord> {
     ...
     */
    public getByIdLinkApplication(boardingLinkId: number, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.BoardingLinkQueryRecord> {
    ...
    private async __getByIdLinkApplication(boardingLinkId: number, requestOptions?: BoardingClient.RequestOptions): Promise<core.WithRawResponse<Payabli.BoardingLinkQueryRecord>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/Boarding/linkbyId/{boardingLinkId}");
    }

    /**
     * Get details for a boarding link using the boarding template ID. This endpoint requires an application API token.
     *
     * @param {number} templateId - The boarding template ID. You can find this at the end of the boarding template URL in the Payabli Portal. Example: `https://partner-sandbox.payabli.com/myorganization/boarding/edittemplate/80`. Here, the template ID is `80`.
     * @param {BoardingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Payabli.BadRequestError}
     * @throws {@link Payabli.UnauthorizedError}
     ...
     */
    public getByTemplateIdLinkApplication(templateId: number, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.BoardingLinkQueryRecord> {
    ...
    private async __getByTemplateIdLinkApplication(templateId: number, requestOptions?: BoardingClient.RequestOptions): Promise<core.WithRawResponse<Payabli.BoardingLinkQueryRecord>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/Boarding/linkbyTemplate/{templateId}");
    }
     ...
     */
    public getExternalApplication(appId: number, mail2: string, request: Payabli.GetExternalApplicationRequest = {}, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse00> {
        return core.HttpResponsePromise.fromPromise(this.__getExternalApplication(appId, mail2, request, requestOptions));
    }
    ...
    private async __getExternalApplication(appId: number, mail2: string, request: Payabli.GetExternalApplicationRequest = {}, requestOptions?: BoardingClient.RequestOptions): Promise<core.WithRawResponse<Payabli.PayabliApiResponse00>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/Boarding/applink/{appId}/{mail2}");
    }
     ...
     */
    public getLinkApplication(boardingLinkReference: string, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.BoardingLinkQueryRecord> {
    ...
    private async __getLinkApplication(boardingLinkReference: string, requestOptions?: BoardingClient.RequestOptions): Promise<core.WithRawResponse<Payabli.BoardingLinkQueryRecord>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/Boarding/link/{boardingLinkReference}");
    }
     ...
     *     })
     */
    public listApplications(orgId: number, request: Payabli.ListApplicationsRequest = {}, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.QueryBoardingAppsListResponse> {
    ...
    private async __listApplications(orgId: number, request: Payabli.ListApplicationsRequest = {}, requestOptions?: BoardingClient.RequestOptions): Promise<core.WithRawResponse<Payabli.QueryBoardingAppsListResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Payabli.QueryBoardingAppsListResponse, rawResponse: _response.rawResponse };
        }
     ...
     *     })
     */
    public listBoardingLinks(orgId: number, request: Payabli.ListBoardingLinksRequest = {}, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.QueryBoardingLinksResponse> {
     ...
     *     })
     */
    public addServiceToPaypointFromApp(request: Payabli.CreateApplicationFromPaypointRequest, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.CreateApplicationFromPaypointResponse> {
    ...
    private async __addServiceToPaypointFromApp(request: Payabli.CreateApplicationFromPaypointRequest, requestOptions?: BoardingClient.RequestOptions): Promise<core.WithRawResponse<Payabli.CreateApplicationFromPaypointResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Payabli.CreateApplicationFromPaypointResponse, rawResponse: _response.rawResponse };
        }
     ...
     */
    public getApplicationsByPaypointId(paypointId: number, requestOptions?: BoardingClient.RequestOptions): core.HttpResponsePromise<Payabli.QueryBoardingAppsListResponse> {
