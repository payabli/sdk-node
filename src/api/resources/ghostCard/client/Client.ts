...
export class GhostCardClient {
     ...
     *     })
     */
    public createGhostCard(entry: Payabli.Entry, request: Payabli.CreateGhostCardRequestBody, requestOptions?: GhostCardClient.RequestOptions): core.HttpResponsePromise<Payabli.CreateGhostCardResponse> {
     ...
     *     })
     */
    public updateCard(entry: Payabli.Entry, request: Payabli.UpdateCardRequestBody, requestOptions?: GhostCardClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse> {
