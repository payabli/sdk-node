...
export class CheckCaptureClient {
     ...
     *     })
     */
    public checkProcessing(request: Payabli.CheckCaptureRequestBody, requestOptions?: CheckCaptureClient.RequestOptions): core.HttpResponsePromise<Payabli.CheckCaptureResponse> {
