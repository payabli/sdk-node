...
export class PaymentLink {
    protected readonly _options: PaymentLink.Options;

    constructor(_options: PaymentLink.Options = {}) {
    ...
    private async __addPayLinkFromBill(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.PayabliTimeoutError("Timeout exceeded when calling POST /PaymentLink/bill/{billId}.");
            case "unknown":
                throw new errors.PayabliError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __addPayLinkFromBillLotNumber(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.PayabliTimeoutError(
                    "Timeout exceeded when calling POST /PaymentLink/bill/lotNumber/{lotNumber}.",
                );
            case "unknown":
                throw new errors.PayabliError({
                    message: _response.error.errorMessage,
