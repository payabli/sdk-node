...
export class HostedPaymentPagesClient {
     ...
     */
    public loadPage(entry: string, subdomain: string, requestOptions?: HostedPaymentPagesClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliPages> {
     ...
     *     })
     */
    public newPage(entry: string, request: Payabli.NewPageRequest, requestOptions?: HostedPaymentPagesClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse00Responsedatanonobject> {
     ...
     */
    public savePage(entry: string, subdomain: string, request: Payabli.PayabliPages, requestOptions?: HostedPaymentPagesClient.RequestOptions): core.HttpResponsePromise<Payabli.PayabliApiResponse00Responsedatanonobject> {
