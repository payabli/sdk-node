...
const ENV_CLIENT_ID = "OAUTH_CLIENT_ID" as const;
const ENV_CLIENT_SECRET = "OAUTH_CLIENT_SECRET" as const;
...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    private readonly authClient: TokenClient;
    ...
    constructor(options: OAuthAuthProvider.Options & OAuthAuthProvider.ClientCredentials) {
                ...
                this.authClient = new TokenClient(options);
            ...
            endpointMetadata?: core.EndpointMetadata;
                ...
                this.refreshPromise = (async () => {
                    try {
                        ...
                        const tokenResponse = await this.authClient.createServerSideToken({
                            clientId: clientId,
...
export namespace OAuthAuthProvider {
    ...
    export type ClientCredentials = {
                [WRAPPER_PROPERTY]?: { [CLIENT_ID_PARAM]?: core.EndpointSupplier<string> | undefined; [CLIENT_SECRET_PARAM]?: core.EndpointSupplier<string> | undefined };
            };
