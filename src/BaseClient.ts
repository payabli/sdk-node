...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@payabli/sdk-node", "X-Fern-SDK-Version": "1.0.6", "User-Agent": "@payabli/sdk-node/1.0.6", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version },
        options?.headers
    );
