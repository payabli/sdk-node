...
export type AuthOption =
    ...
    | core.AuthProvider
    | (RoutingAuthProvider.AuthOptions<[OAuthAuthProvider.AuthOptions, HeaderAuthProvider.AuthOptions]>);
...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@payabli/sdk-node", "X-Fern-SDK-Version": "1.0.7", "User-Agent": "@payabli/sdk-node/1.0.7", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version },
        options?.headers
    );
...
export function normalizeClientOptionsWithAuth<T extends BaseClientOptions = BaseClientOptions>(
    ...
    normalized.authProvider ??= RoutingAuthProvider.createInstance(normalizedWithNoOpAuthProvider, [OAuthAuthProvider, HeaderAuthProvider]);
    return normalized;
}
