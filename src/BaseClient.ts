...
export type AuthOption =
    ...
    | core.AuthProvider
    | (AnyAuthProvider.AuthOptions<[OAuthAuthProvider.AuthOptions, HeaderAuthProvider.AuthOptions]>);
...
export function normalizeClientOptionsWithAuth<T extends BaseClientOptions = BaseClientOptions>(
    ...
    normalized.authProvider ??= AnyAuthProvider.createInstance(normalizedWithNoOpAuthProvider, [OAuthAuthProvider, HeaderAuthProvider]);
    return normalized;
}
