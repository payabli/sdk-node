...
**customerId:** `number` — Payabli-generated customer ID. Maps to "Customer ID" column in the Payabli Portal.
...
## Token
<details><summary><code>client.token.<a href="/src/api/resources/token/client/Client.ts">createServerSideToken</a>({ ...params }) -> Payabli.PayabliAccessTokenResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.query.<a href="/src/api/resources/query/client/Client.ts">listBatchDetailsOrg</a>(orgId, { ...params }) -> Payabli.QueryBatchesDetailResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.query.listTransferDetails("8cfec329267", 4521);
...
```typescript
await client.query.listTransfers("8cfec329267", {
    fromRecord: 0,
    limitRecord: 20
});
...
<details><summary><code>client.query.<a href="/src/api/resources/query/client/Client.ts">listTransfersOrg</a>(orgId, { ...params }) -> Payabli.TransferQueryResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.query.listTransfersOrg(123, {
    fromRecord: 0,
    limitRecord: 20
});
...
```typescript
await client.query.listTransfersOutPaypoint("8cfec329267", {
    fromRecord: 0,
    limitRecord: 20
});
...
```typescript
await client.query.listTransferDetailsOut("8cfec329267", 4521, {
    fromRecord: 0,
    limitRecord: 20
});
...
**templateId:** `number` — The boarding template ID. You can find this at the end of the boarding template URL in the Payabli Portal. Example: `https://partner-sandbox.payabli.com/myorganization/boarding/edittemplate/80`. Here, the template ID is `80`.
...
<details><summary><code>client.organization.<a href="/src/api/resources/organization/client/Client.ts">editOrganization</a>(orgIdPathParam, { ...params }) -> Payabli.EditOrganizationResponse</code></summary>
<dl>
<dd>
...
**orgIdPathParam:** `number` — The numeric identifier for organization, assigned by Payabli.
...
## Billing
<details><summary><code>client.billing.<a href="/src/api/resources/billing/client/Client.ts">listProfiles</a>(orgId, { ...params }) -> Payabli.BillingProfileQueryResponse</code></summary>
<dl>
<dd>
...
**orgId:** `number` — The organization's numeric identifier.
...
<details><summary><code>client.billing.<a href="/src/api/resources/billing/client/Client.ts">getProfile</a>(serviceGroup, entityType, entityId) -> Payabli.BillingProfileResponse</code></summary>
<dl>
<dd>
...
**entityId:** `number` — The numeric identifier of the entity.
