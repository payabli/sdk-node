...
describe("TokenStorageClient", () => {
    ...
    test("AddMethod (1)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/TokenStorage/add").jsonBody(rawRequestBody)
                .respondWith()
    ...
    test("GetMethod (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/TokenStorage/32-8877drt00045632-678").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("GetMethod (4)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/TokenStorage/methodId").respondWith()
            .statusCode(400).jsonBody(rawResponseBody)
                .build();
    ...
    test("UpdateMethod (1)", async () => {
        ...
        server
            .mockEndpoint()
            .put("/TokenStorage/32-8877drt00045632-678").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("RemoveMethod (1)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/TokenStorage/32-8877drt00045632-678").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("RemoveMethod (2)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/TokenStorage/methodId").respondWith()
            .statusCode(400).jsonBody(rawResponseBody)
                .build();
